  ...
  description: (
    <>
      <p className="prose-sm text-stone-200 sm:prose-base lg:prose-lg">
        ...
        Proficient in <strong className="text-stone-100">Python, React, Django,</strong> and{' '}
        <strong className="text-stone-100">AWS</strong>, with expertise in{' '}
        <strong className="text-stone-100">LLMs, NLP</strong>, and <strong className="text-stone-100">MLOps</strong>.
...
export const portfolioItems: PortfolioItem[] = [
  {
    ...
    description:
      'Real-time fraud detection system using machine learning to analyze transaction patterns and detect anomalies.',
    ...
    content: (
      <>
        <div>
          ...
          <br />
          <p>
            I developed and deployed a real-time fraud detection system for financial transactions, designed to flag
            suspicious activity and reduce false positives that were costing the business both revenue and customer
            trust.
            <br />
          </p>
        </div>
        ...
        <div>
          ...
          <br />
          <p>
            Engineered real-time features like transaction velocity, location mismatches, device fingerprint patterns
            <br />
            Reduced model latency by optimizing inference pipeline and using quantized models
            <br />
            Designed feedback loop with weekly model retraining using labeled fraud outcomes
            <br />
            Collaborated with risk and payments teams to tune risk thresholds and action triggers
            <br />
          </p>
        </div>
        <div>
          ...
          <br />
          <p>
            Latency Constraint: Had to respond in under 200ms. Solved by caching features in Redis and running
            lightweight inference services close to edge using AWS Lambda.
            <br />
            Data Drift: Fraud patterns changed frequently, so built auto-monitoring for feature distributions and
            retraining triggers.
            <br />
            Label Noise: Many transactions were misclassified manually. Introduced semi-supervised learning and active
    ...
    content: (
      <>
        <div>
          ...
          <br />
          <p>
            I built a virtual healthcare assistant to automate appointment scheduling and answer common medical-related
            questions (e.g., symptoms, medications, doctor availability). The goal was to reduce human involvement and
            response time in clinics or health portals.
            <br />
          </p>
        </div>
        <div>
          ...
          <br />
          <p>
            NLP engine: Used Hugging Face Transformers, specifically DistilBERT and later BERT-base, fine-tuned on a
            domain-specific Q&A dataset for intent classification and response generation.
            <br />
            Rasa: Managed conversation flows, intent classification, and dialogue policies. Custom actions handled
            appointment booking and entity extraction.
            <br />
        ...
        <div>
          ...
          <br />
          <p>
            100+ Intents like “book appointment,” “cancel appointment,” “doctor available today?”, “clinic hours,” “I
            have chest pain,” etc.
            <br />
        ...
        <div>
          ...
          <br />
          <p>
            Ambiguous user inputs – Many medical queries are vague (e.g., “I feel bad”). Solved by enriching training
            data with paraphrased examples and using confidence thresholds with fallback handling.
            <br />
            Entity recognition for medical terms – Standard models failed to catch domain-specific entities like drug
            names or conditions. Used custom NER tagging with spaCy and fine-tuned biomedical embeddings (BioBERT).
            <br />
            Latency optimization – Transformer models were initially slow in inference. I optimized it by switching to
            ONNX runtime and used batching + GPU acceleration in production testbed.
            <br />
            Handling sensitive data – Designed the pipeline to be HIPAA-compliant ready (no real PII was used), and
    ...
    content: (
      <>
        <div>
          ...
          <br />
          <p>
            I designed and deployed a real-time recommendation system for an e-commerce platform aimed at improving
            customer retention and engagement. The primary goal was to provide dynamic, personalized product suggestions
            that respond to user behavior in real time — ultimately reducing user churn.
          </p>
        </div>
        <div>
          🧰 Tools and Technologies:
          ...
          <p>
            ...
            <br />
            Modeling: Collaborative Filtering (Matrix Factorization via LightFM), Neural Collaborative Filtering (NCF),
            and a hybrid content-based layer (TF-IDF + product embeddings using Sentence-BERT)
            <br />
            Infrastructure: Airflow for training pipeline orchestration, MLflow for tracking, AWS SageMaker for model
        ...
        <div>
          ...
          <br />
          <p>
            Built end-to-end pipelines: user-item matrix generation, feature extraction, model training, and batch +
            real-time serving
            <br />
            Designed model inference API with sub-150ms latency to serve recommendations during user session
            <br />
            Implemented feedback loop using implicit feedback (clicks, time-on-page, purchases) to fine-tune ranking
            models weekly
            <br />
        ...
        <div>
          ...
          <br />
          <p>
            Cold Start for New Users/Items: Solved using metadata-based content filtering backed by sentence embeddings
            of product descriptions and user demographics
            <br />
            Sparse Interaction Matrix: Applied matrix factorization with confidence weighting + side information to
            improve performance
            <br />
            Scalability: Introduced sharded user embeddings and used Faiss/Annoy for fast nearest-neighbor lookups under
            load
            <br />
            Drift Monitoring: Monitored CTR, conversion rate, and product diversity in recommendations daily to trigger
    ...
    content: (
      <>
        <div>
          🔍 Overview:
          <p>
            I built and deployed a CNN-based computer vision pipeline to parse structured and semi-structured documents
            like invoices, receipts, and forms. The goal was to automate information extraction (e.g., dates, totals,
            vendor names) with over 85% accuracy.
          </p>
        </div>
        <div>
          🧰 Tools and Technologies:
          ...
          <p>
            ...
            <br />
            Modeling: Custom Convolutional Neural Networks + pre-trained backbones like EfficientNet for layout
            classification
            <br />
        ...
        <div>
          ...
          <p>
            ...
            <br />
            Complex layouts with varying formats: Trained layout classification models and used positional anchors for
            consistency
            <br />
            Imbalanced training data: Applied augmentation techniques like cropping, noise injection, and rotation to
            generalize better
            <br />
...
export const experience: TimelineItem[] = [
  {
    ...
    content: (
      <div>
        <p>
          - Developed and deployed a real-time fraud detection system that reduced false positives by 30% and improved
          detection accuracy by 25%
        </p>
        <p>
          - Built a NLP-powered virtual assistant for scheduling appointments and answering health-related FAQs using
          Hugging Face Transformers and Rasa, reducing response latency under 1s for 100+ intents.
        </p>
        <p>
          - Utilized Langchain to build modular and scalable prompt workflows for NLP tasks, enhancing the performance
          of customer support systems
        </p>
        <p>
          - Led MLOps integration using MLflow and Docker, cutting deployment time by 40% Collaborated with
          cross-functional teams to productionize models via REST APIs on AWS
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>- Built predictive models for financial forecasting and risk classification using ensemble techniques</p>
        <p>
          - Designed and deployed end-to-end ML pipelines for real-time recommendation systems (reduced churn by 17%)
        </p>
        <p>- Automated data pipelines with Airflow, reducing manual ETL time by 60%</p>
        <p>
          - Designed and deployed an admin portal using Django + React for product analysts to manage ML experiments and
          model metadata.
        </p>
        <p>
          - Collaborated with UX designers to implement responsive UIs with Tailwind CSS. Implemented computer vision
          models (CNN) for document parsing (85%+ accuracy) Integrated Langchain for building dynamic prompt-based
          solutions, enabling more flexible text extraction and classification
        </p>
        <p>- Conducted A/B tests and model performance monitoring in production</p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div>
        <p>- Assisted in collecting and preprocessing sales data for forecasting models</p>
        <p>- Built simple linear regression models to analyze regional sales trends</p>
        <p>- Presented findings to non-technical stakeholders</p>
        <p>
          - Built dashboards in Plotly Dash and performed trend analysis with SQL and Pandas to support marketing
          strategies.
        </p>
      </div>
    ),
...
export const contact: ContactSection = {
  ...
  description:
    'Welcome to my contact page! I am always open to discussing new projects, creative ideas, or opportunities to be part of your vision.',
  items: [
    {
